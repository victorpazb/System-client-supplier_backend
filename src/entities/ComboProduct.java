...
public class ComboProduct extends Product implements Comparable<Product> {
	...
	private double priceWithDiscount, discountFactor, priceWithoutDiscount;
	...
	/**
	 * Calculates the price of the combo with NO discount.
	 * Just adding the price of products that compose it
	 * 
